...
namespace MD2
{
	public class WorkGiver_CollectSand : WorkGiver_Scanner//WorkGiver
    {
        ...
        {
            return pawn.Faction == Faction.OfColony && Find.DesignationManager.DesignationAt(c, DefDatabase<DesignationDef>.GetNamed("MD2CollectSand")) != null && pawn.CanReserveAndReach(c, Verse.AI.PathEndMode.OnCell, Danger.Some);
        }
